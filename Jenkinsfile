...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 docker build -t 742376008946.dkr.ecr.ap-south-1.amazonaws.com/amith:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 742376008946.dkr.ecr.ap-south-1.amazonaws.com/amith:SAMPLE-PROJECT-${BUILD_NUMBER}
